...
const navItems = [
  ...
  { to: "/app/manager/inventory/inputs", label: "Insumos", icon: ClipboardList, permission: "products.view" },
  { to: "/app/manager/production/recipes", label: "Recetas", icon: ClipboardList, permission: "recipes.view" },
