...
import { labelProductType, labelStatus } from "../../../shared/utils/labels";
  ...
  return (
    <section>
      <div className="mb-6">
        ...
        <h1 className="mt-3 text-2xl font-semibold">Existencias</h1>
        <p className="mt-2 text-sm text-tp-muted">Corrige conteos y registra producto perdido o danado.</p>
      </div>
      ...
      <div className="mb-5 rounded-md border border-tp-border bg-white p-4">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
          <p className="text-sm text-tp-muted">
            {selectedProduct ? `Unidad: ${selectedProduct.unit}. Existencia actual: ${selectedProduct.currentStock}` : "Selecciona un producto para mover inventario."}
          </p>
