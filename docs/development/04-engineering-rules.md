...
- `DELIVERY_SETTLEMENT_NOT_FOUND`
- `INVALID_DELIVERY_STATUS`
- `RETURN_ALREADY_REVIEWED`
- `GLOBAL_INVOICE_ALREADY_EXISTS`
- `NO_SALES_TO_INVOICE`
- `INVOICE_CANNOT_BE_EDITED`
- `PAC_STAMPING_FAILED`
- `SERVICE_UNAVAILABLE`
